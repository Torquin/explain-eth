...
const TransactionHistoryOverlay: React.FC<TransactionHistoryOverlayProps> = ({
  ...
  return (
    <>
      ...
      <div className={`
        fixed bottom-4 right-4 w-7/8 max-w-sm sm:w-96 mx-4 sm:mx-0 bg-gray-800 border border-gray-700 rounded-lg shadow-xl z-50 transition-all duration-300 ease-in-out
